...
`define PHT_CHECK_VALID         `PHT_COUNTER_LEN:`PHT_COUNTER_LEN
`define PHT_CHECK_COUNT         `PHT_COUNTER_LEN-1:0
`define PHT_CHECK_BASE          (`PHT_COUNTER_LEN+1)
`define PHT_CHECKPOINT_LEN      `PHT_CHECK_BASE
...
`define RAS_CHECK_PC        30+`RAS_ENRTY_NUM_LEN-1+`PHT_CHECK_BASE:`RAS_ENRTY_NUM_LEN+`PHT_CHECK_BASE
`define RAS_CHECK_TOP       (`RAS_ENRTY_NUM_LEN-1+`PHT_CHECK_BASE):`PHT_CHECK_BASE
//}}}
`define ALL_CHECKPOINT_LEN      (`RAS_CHECKPOINT_LEN+`PHT_CHECKPOINT_LEN)
